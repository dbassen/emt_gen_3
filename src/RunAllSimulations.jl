...
include("../src/new_SimulationFunctions.jl") # move all includes to Include.jl # Call from top level function
...
control_parameter_array[9,1]=1.0 # GAIN # REP_ECAD_PSMAD # was 5
...
# uncomment and add to list to run more simulations
simulations_name = ["edit_file_none.jl","edit_file_1dyne_per_cm2_0hz.jl","edit_file_5dyne_per_cm2_0hz.jl","edit_file_10dyne_per_cm2_0hz.jl","edit_file_1dyne_per_cm2_1hz.jl","edit_file_5dyne_per_cm2_1hz.jl","edit_file_10dyne_per_cm2_1hz.jl"]#,"edit_file_tgfb.jl","edit_file_mapkin.jl","edit_file_ss.jl","edit_file_ssecad.jl","edit_file_ss_tgfb3ab.jl","edit_file_ss_dnlef1.jl","edit_file_tgfb3.jl","edit_file_dnsmad.jl","edit_file_tgfb3_dnlef1.jl","edit_file_tgfb_tgfb3ab.jl"]
# These are the factory functions but they can be placed in the datafile
...
for sim in simulations
  ...
  (TSIM,X) = SolveModelGeneric_ram(TSTART,TSTOP,Ts,data_dictionary_active,sim,sim_ICA)

  outdir="../output/handfit/" # Fig2Simulations
