...
ACTORS = ['','','SNAIL_SLUG:SNAIL_SLUG*Active_LEF1','Active_LEF1:Active_LEF1*pSmad*Active_YAP'] # old:new '' means no modification
...
GROUPS=[activators]
INTEGR=['maximum']
ACTORS=['SNAIL_SLUG:SNAIL_SLUG*Active_YAP1','']
pointer.reconfigure(GROUPS,INTEGR,ACTORS)
