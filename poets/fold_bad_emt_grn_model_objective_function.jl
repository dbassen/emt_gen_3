...
control_parameter_array[23,2] = 1;	#	23 Order: 	activation_CD1_by_SHEAR_STRESS_2 target: induction_gene_CD31 actor: SHEAR_STRESS_2 type: induction
...
MOD_FOLD = MOD/MOD[1]
obj_array[1]  = SSE(MOD_FOLD,QPC_FOLD)
...
MOD_FOLD = MOD/MOD[1]
obj_array[2]  = SSE(MOD_FOLD,QPC_FOLD)
...
MOD_FOLD = MOD/MOD[1]
obj_array[3]  = SSE(MOD_FOLD,QPC_FOLD)

#4 mrna_slug STEADY SHEAR
...
MOD_FOLD = MOD/MOD[1]
obj_array[4] = SSE(MOD_FOLD,QPC_FOLD)
...
MOD_FOLD = MOD/MOD[1]
obj_array[5]  = SSE(MOD_FOLD,QPC_FOLD)
...
MOD_FOLD = MOD/MOD[1]
obj_array[6]  = SSE(MOD_FOLD,QPC_FOLD)
...
MOD_FOLD = MOD/MOD[1]
obj_array[7]  = SSE(MOD_FOLD,QPC_FOLD)
...
MOD_FOLD = MOD/MOD[1]
obj_array[8] = SSE(MOD_FOLD,QPC_FOLD)
