...
#   data_dictionary["RATE_CONSTANT_ARRAY"]=rate_constant_array
 ...
 #println("running to SS")
  ...
  simulations = ["edit_file_none.jl","edit_file_1dyne_per_cm2_0hz.jl","edit_file_5dyne_per_cm2_0hz.jl","edit_file_10dyne_per_cm2_0hz.jl","edit_file_1dyne_per_cm2_1hz.jl","edit_file_5dyne_per_cm2_1hz.jl","edit_file_10dyne_per_cm2_1hz.jl"]
...
base_ecad = base_[ti:tf,index_ecad] #+ base_[ti:tf,index_active_nfatc_bcat]
pert_ecad = pert_[ti:tf,index_ecad] #+ pert_[ti:tf,index_active_nfatc_bcat]
base_vim  = base_[ti:tf,index_vim ]
pert_vim  = pert_[ti:tf,index_vim ]

# compute calculate 5 SS abundance
...
writedlm(string(out_dir,"Abundance_training_set_shear",".dat"),robustness_array,',')
