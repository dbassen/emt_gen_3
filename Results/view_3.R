...
osc_1_a<-c(osc_1_48$YAP1,osc_1_48$Active_YAP1,osc_1_48$CD31,osc_1_48$RhoA_GTP,osc_1_48$Ecadherin+osc_1_48$Ecadherin_Bcatenin)

osc_5_48 <- osc_5[250,] # select last timepoint (48hrs)
osc_5_a<-c(osc_5_48$YAP1,osc_5_48$Active_YAP1,osc_5_48$CD31,osc_5_48$RhoA_GTP,osc_5_48$Ecadherin+osc_5_48$Ecadherin_Bcatenin)

lss_5_48 <- lss_5[250,] # select last timepoint (48hrs)
lss_5_a<-c(lss_5_48$YAP1,lss_5_48$Active_YAP1,lss_5_48$CD31,lss_5_48$RhoA_GTP,lss_5_48$Ecadherin+lss_5_48$Ecadherin_Bcatenin)

lss_10_48 <- lss_10[250,] # select last timepoint
lss_10_a<-c(lss_10_48$YAP1,lss_10_48$Active_YAP1,lss_10_48$CD31,lss_10_48$RhoA_GTP,lss_10_48$Ecadherin+lss_10_48$Ecadherin_Bcatenin)
...
means <- xss_dat_a
lvls  <- c("YAP1", "YAPN'","PECAM",  "RhoGTP", "Ecad")
padx   <- 0.0
